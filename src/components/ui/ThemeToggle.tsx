...
/**
 * Day/night toggle for Settings > General > Appearance ONLY.
 * Based on Uiverse.io JustCode14 design (stars + cloud + sun/moon).
 * Does NOT reuse src/components/ui/Toggle.tsx.
 *
 * checked = dark mode (moon visible, night sky)
