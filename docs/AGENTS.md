...
Production app with active feature development. Current version: `3.4.6`. See `CHANGELOG.md` for full version history and `VERSIONING.md` for versioning policy (MAJOR.FEATURE.DEBUG format).
